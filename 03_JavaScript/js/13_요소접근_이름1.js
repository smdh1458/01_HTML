...
function checkbox로valueChecked속성확인() {
  ...
  //alert("1번 hobbys만 작성 :" + hobbys); // object NodeList 유사한 배열형태다
  //alert("2번 hobbys[0]만 작성 :" + hobbys[0]); // object HTMLInputElement html input 요소다
  //alert("3번 hobbys[0].value 만 작성 :" + hobbys[0].value); // 유사배열에서 0번째에 있는 값은 게임이다.
